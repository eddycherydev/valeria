# Valeria Framework — Documentation

| Topic | Description |
|-------|-------------|
| [Configuration](configuration.md) | Environment variables, `.env`, database settings |
| [Routing](routing.md) | Defining routes, parameters, middleware groups, macros |
| [Middleware](middleware.md) | Route and attribute middleware, interface, examples |
